...
//	商户密钥:773835225442
     ...
     * 支付生成URL
     */
    public static URL PAY_URL;
    /**
     * 订单查询URL
     */
    public static URL QUERY_URL;
    /**
     * 订单退款URL
     */
     ...
     */
    public static String NOTIFY_URL = "http://139.155.248.244/ttmy_admin/api/pay/callback/lidcloudpay";
    /**
     ...
     * 商户号，正式上线需要修改为自己的商户号
     */
    public static String MERCHANT_NO = "8066168206869065";
    /**
     * 商户密钥，正式上线需要修改为自己的商户密钥
     */
    private static String SECRET = "773835225442";
     ...
     *
     * @param orderNo 订单号
     * @param total   订单金额，单位为分
     * @return
     */
    public static String pay(String orderNo, String total) {

        Map<String, String> params = new HashMap<>();
        params.put("merchantNo", MERCHANT_NO);
        params.put("notifyUrl", NOTIFY_URL);
        params.put("returnUrl", RETURN_URL);
        params.put("payMethod", "6015");
        params.put("version", "v2.0");
        params.put("name", "冰红茶-三折优惠");
        params.put("orderNo", orderNo);
        params.put("total", total);
        params.put("timestamp", String.valueOf(System.currentTimeMillis()));
        params.put("sign", getSign(params));

        return sendPostMessage(PAY_URL, params);
    }
    ...
    public static String orderQuery(String orderNo) {
        ...
        return sendPostMessage(QUERY_URL, params);
    }
     ...
     *
     * @param orderNo     订单号
     * @param refundFee   退款金额，请与订单金额保持一致
     * @param refundReson 退款原因
     * @return
     */
    public static String orderRefund(String orderNo, String refundFee, String refundReson) {
        ...
        return sendPostMessage(REFUND_URL, params);
    }
    ...
    private static void testPay() {
        ...
        String result = pay(orderNo, total);
     ...
     */
    private static void testOrderRefund() {

        String orderNo = "20180818134611";
        String total = "100";

        // ************订单退款，全额退款，简单接口，无须验签************
        String result = orderRefund(orderNo, total, "协商退款");
        System.out.println(result);
