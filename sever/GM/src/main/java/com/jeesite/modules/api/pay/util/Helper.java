...
import com.jeesite.modules.api.pay.entity.Callback;
...
public class Helper {
    ...
    public static String filterNullParams(Object obj, String key) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            result = result + (i > 0 ? str.contains("status") ? "&" + str.replace("	", "=")
                : str.replace("ly", "&ly").replace("	", "=")
    ...
    public static boolean checkSign(Callback callback) throws Exception {
        ...
        return SignUtil.verifySign(param, sign, "RSA_1_256", new CloudPayConfig().platPublicKey);
    }
