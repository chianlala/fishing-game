package com.jeesite.modules.api.pay.entity;
...
public class Order implements Serializable {
    ...
    private String ly_payer_ip;

    public Order(String ly_user_id, String ly_order_no, String ly_money, String ly_trade_type,
        String ly_return_url,
        String ly_notify_url, String ly_notes, String ly_sign_type, String ly_scan_code,
        String ly_skip_not_page,
        String ly_body, String ly_payer_ip) {
        super();
    ...
    public String getLy_payer_ip() {
        return ly_payer_ip;
    }

    public void setLy_payer_ip(String ly_payer_ip) {
        this.ly_payer_ip = ly_payer_ip;
    }
}
