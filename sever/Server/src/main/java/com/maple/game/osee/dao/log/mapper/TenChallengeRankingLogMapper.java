...
public interface TenChallengeRankingLogMapper {
    ...
    @Update("create table if not exists " + TABLE_NAME + " (" + "`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',"
        + "`user_id` bigint(20) NOT NULL COMMENT '用户id'," + "`nickname` varchar(64) NULL DEFAULT NULL COMMENT '昵称',"
        + "`head_index` int(11) NULL DEFAULT NULL COMMENT '头像序号',"
        + "`head_url` varchar(512) NULL DEFAULT NULL COMMENT '头像地址'," + "`score` bigint(20) NOT NULL COMMENT '得分',"
    ...
    @Insert("insert into " + TABLE_NAME + " (" + "user_id, nickname, head_index, head_url, score" + ") values ("
    ...
    @Update("update " + TABLE_NAME + " set "
        ...
        + "score = #{entity.score}, update_time = #{entity.updateTime} " + "where id = #{entity.id}")
