...
public interface OseeFighttenRecordLogMapper {
    ...
    @Insert("INSERT INTO " + TABLE_NAME
        + " (`money`, `playerId`, `nickname`, `playBeforeMoney`, `playAfterMoney`, `input`, `rate`, `cardType`) "
    ...
    @Update("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录id',"
        ...
        + "`input` bigint(20) NOT NULL COMMENT '下注金额'," + "`rate` int(20) NULL DEFAULT NULL COMMENT '倍率',"
