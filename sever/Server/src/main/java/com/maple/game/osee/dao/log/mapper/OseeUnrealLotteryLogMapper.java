...
public interface OseeUnrealLotteryLogMapper {
    ...
    @Update("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录id',"
        ...
        + "`reward_name` varchar(32) NULL DEFAULT NULL COMMENT '商品名'," + "`type` int(11) NOT NULL COMMENT '类型',"
        + "`count` int(11) NOT NULL COMMENT '兑换数量'," + "`item_id` int(11) NOT NULL COMMENT '消耗类型',"
