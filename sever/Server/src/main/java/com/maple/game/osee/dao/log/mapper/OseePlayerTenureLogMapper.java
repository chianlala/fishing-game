...
public interface OseePlayerTenureLogMapper {
    ...
    @Insert("INSERT INTO " + TABLE_NAME + " (`user_id`, `nickname`, `reason`, "
        ...
        + "`pre_skill_lock`, `change_skill_lock`, `pre_skill_frozen`, `change_skill_frozen`, `pre_skill_fast`, `change_skill_fast`, `pre_skill_double`, `change_skill_double`, `pre_skill_crit`, `change_skill_crit`,"
        + "`pre_boss_bugle`, `change_boss_bugle`,`pre_dragon_crystal`,`change_dragon_crystal`,`pre_skill_ele`, `change_skill_ele`,`pre_rare_torpedo`, `change_rare_torpedo`,`pre_rare_torpedo_bang`, `change_rare_torpedo_bang`"
        + ") VALUES (" + "#{entity.userId}, #{entity.nickname}, #{entity.reason}, "
        ...
        + "#{entity.preSkillLock}, #{entity.changeSkillLock}, #{entity.preSkillFrozen}, #{entity.changeSkillFrozen}, #{entity.preSkillFast}, #{entity.changeSkillFast}, #{entity.preSkillDouble}, #{entity.changeSkillDouble}, #{entity.preSkillCrit}, #{entity.changeSkillCrit},"
        + "#{entity.preBossBugle}, #{entity.changeBossBugle},#{entity.preDragonCrystal},#{entity.changeDragonCrystal},#{entity.preSkillEleTic}, #{entity.changeSkillEleTic},#{entity.preRareTorpedo}, #{entity.changeRareTorpedo},#{entity.preRareTorpedoBang}, #{entity.changeRareTorpedoBang}"
        + ")")
    ...
    @Update("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录id',"
        ...
        + "`pre_skill_double` bigint(20) NULL COMMENT '变动前翻倍技能数量',`change_skill_double` bigint(20) NULL COMMENT '变动的翻倍技能数量',"
