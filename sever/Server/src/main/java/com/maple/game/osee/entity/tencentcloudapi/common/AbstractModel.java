...
package com.maple.game.osee.entity.tencentcloudapi.common;
...
public abstract class AbstractModel {
    ...
    /**
     * Any stores customized parameters which are not documented. You should make sure it can be correctly serialized to
     * json string.
     */
    ...
    /**
     * Valid only when it's a request object. Some actions can only be posted in multipart format, this method is used
     * to mark which parameters are binary type.
     */
    ...
    /**
     * Recursively generate obj's JSON object. Even if obj.any() is empty, this recursive progress cannot be skipped
     * because customized additional parameter might be hidden in lower data structure.
     *
     * @param obj
     * @return
     */
