...
public interface TwoEightRecordMapper {
    ...
    @Insert("INSERT INTO " + TABLE_NAME
        + " (`money`, `playerId`, `nickname`, `playBeforeMoney`, `playAfterMoney`, `input`,  `cardType`) "
    ...
    @Update("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录id',"
        ...
        + "`input` bigint(20) NOT NULL COMMENT '下注金额'," + "`cardType` varchar(128) NULL DEFAULT NULL COMMENT '牌型',"
