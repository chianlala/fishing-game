...
public interface OseeRealLotteryLogMapper {
    ...
    @Update("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录id',"
        ...
        + "`order_num` varchar(32) NULL DEFAULT NULL COMMENT '订单号'," + "`user_id` bigint(20) NOT NULL COMMENT '兑换人id',"
        + "`nickname` varchar(32) NULL DEFAULT NULL COMMENT '昵称',"
        + "`reward_name` varchar(32) NULL DEFAULT NULL COMMENT '商品名'," + "`count` int(11) NOT NULL COMMENT '兑换数量',"
        + "`cost` int(11) NOT NULL COMMENT '消耗数量'," + "`creator` varchar(32) NULL DEFAULT NULL COMMENT '创建人',"
        + "`consignee` varchar(32) NULL DEFAULT NULL COMMENT '收货人',"
        + "`phone_num` varchar(32) NULL DEFAULT NULL COMMENT '手机号',"
        + "`address` varchar(32) NULL DEFAULT NULL COMMENT '收货地址'," + "`order_state` int(11) NOT NULL COMMENT '状态',"
