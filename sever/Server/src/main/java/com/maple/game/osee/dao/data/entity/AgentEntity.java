...
public class AgentEntity extends DbEntity {
    ...
    public Double getOtherPayRate() {
        return otherPayRate;
    }

    public void setOtherPayRate(Double otherPayRate) {
    ...
    public int getPayWay1() {
        return payWay1;
    }

    public void setPayWay1(int payWay1) {
