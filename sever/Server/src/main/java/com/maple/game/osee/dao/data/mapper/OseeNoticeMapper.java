...
public interface OseeNoticeMapper {
    ...
    @Update("UPDATE " + TABLE_NAME
        + " SET `index`=#{entity.index}, `title`=#{entity.title}, `content`=#{entity.content}, "
    ...
    @Update("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '类型id', "
        ...
        + "`index` int(11) NULL DEFAULT NULL COMMENT '序号', " + "`title` varchar(32) NULL DEFAULT NULL COMMENT '标题', "
        + "`content` varchar(512) NULL DEFAULT NULL COMMENT '内容', " + "`start_time` timestamp NULL COMMENT '生效时间', "
