...
import com.maple.game.osee.entity.tencentcloudapi.common.http.HttpConnection;
...
public abstract class AbstractClient {
    ...
    public static final String SDK_VERSION = "SDK_JAVA_3.1.106";
    ...
    /**
     * Use post/json with tc3-hmac-sha256 signature to call any action. Ignore request method and signature method
     * defined in profile.
     *
     * @param action Name of action to be called.
     * @param jsonPayload Parameters of action serialized in json string format.
     * @return Raw response from API if request succeeded, otherwise an exception will be raised instead of raw response
