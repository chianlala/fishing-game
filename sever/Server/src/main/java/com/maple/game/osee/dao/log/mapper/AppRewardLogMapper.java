...
public interface AppRewardLogMapper {
    ...
    String TABLE_NAME1 = "tbl_app_reward_log1";
    String TABLE_NAME2 = "tbl_app_reward_log2";
    String TABLE_NAME3 = "tbl_app_reward_log3";
    String TABLE_NAME4 = "tbl_app_reward_log4";
    ...
    @Insert("INSERT INTO " + TABLE_NAME + "("
        ...
        + ", `skill_lock`, `skill_fast`, `skill_crit`, `skill_frozen`, `boss_bugle`" + ") VALUES ("
    ...
    @Insert("INSERT INTO " + TABLE_NAME1 + "("
        ...
        + ", #{entity.skillLock}, #{entity.skillFast}, #{entity.skillCrit}, #{entity.skillFrozen}, #{entity.bossBugle})")
    @Options(useGeneratedKeys = true, keyProperty = "entity.id")
    void save1(@Param("entity") AppRewardLogEntity entity);

    @Insert("INSERT INTO " + TABLE_NAME2 + "("
        + "`player_id`, `gold`, `diamond`, `lower_ball`, `middle_ball`, `high_ball`"
        + ", `skill_lock`, `skill_fast`, `skill_crit`, `skill_frozen`, `boss_bugle`" + ") VALUES ("
        + "#{entity.playerId}, #{entity.gold}, #{entity.diamond}, #{entity.lowerBall}, #{entity.middleBall}, #{entity.highBall}"
        + ", #{entity.skillLock}, #{entity.skillFast}, #{entity.skillCrit}, #{entity.skillFrozen}, #{entity.bossBugle})")
    @Options(useGeneratedKeys = true, keyProperty = "entity.id")
    void save2(@Param("entity") AppRewardLogEntity entity);

    @Insert("INSERT INTO " + TABLE_NAME3 + "("
        + "`player_id`, `gold`, `diamond`, `lower_ball`, `middle_ball`, `high_ball`"
        + ", `skill_lock`, `skill_fast`, `skill_crit`, `skill_frozen`, `boss_bugle`" + ") VALUES ("
        + "#{entity.playerId}, #{entity.gold}, #{entity.diamond}, #{entity.lowerBall}, #{entity.middleBall}, #{entity.highBall}"
        + ", #{entity.skillLock}, #{entity.skillFast}, #{entity.skillCrit}, #{entity.skillFrozen}, #{entity.bossBugle})")
    @Options(useGeneratedKeys = true, keyProperty = "entity.id")
    void save3(@Param("entity") AppRewardLogEntity entity);

    @Insert("INSERT INTO " + TABLE_NAME4 + "("
        + "`player_id`, `gold`, `diamond`, `lower_ball`, `middle_ball`, `high_ball`"
        + ", `skill_lock`, `skill_fast`, `skill_crit`, `skill_frozen`, `boss_bugle`" + ") VALUES ("
        + "#{entity.playerId}, #{entity.gold}, #{entity.diamond}, #{entity.lowerBall}, #{entity.middleBall}, #{entity.highBall}"
        + ", #{entity.skillLock}, #{entity.skillFast}, #{entity.skillCrit}, #{entity.skillFrozen}, #{entity.bossBugle})")
    @Options(useGeneratedKeys = true, keyProperty = "entity.id")
    void save4(@Param("entity") AppRewardLogEntity entity);
    ...
    @Update("UPDATE " + TABLE_NAME1 + " \n" + "SET gold = #{entity.gold},\n" + "player_id = #{entity.playerId},\n"
        ...
        + "skill_lock = #{entity.skillLock},\n" + "skill_frozen = #{entity.skillFrozen},\n"
        + "boss_bugle = #{entity.bossBugle}\n" + "WHERE\n" + "id = #{entity.id}")
    int update1(@Param("entity") AppRewardLogEntity entity);

    @Update("UPDATE " + TABLE_NAME2 + " \n" + "SET gold = #{entity.gold},\n" + "player_id = #{entity.playerId},\n"
        + "diamond = #{entity.diamond},\n" + "lower_ball = #{entity.lowerBall},\n"
        + "middle_ball = #{entity.middleBall},\n" + "high_ball = #{entity.highBall},\n"
        + "skill_crit = #{entity.skillCrit},\n" + "skill_fast = #{entity.skillFast},\n"
        + "skill_lock = #{entity.skillLock},\n" + "skill_frozen = #{entity.skillFrozen},\n"
        + "boss_bugle = #{entity.bossBugle}\n" + "WHERE\n" + "id = #{entity.id}")
    int update2(@Param("entity") AppRewardLogEntity entity);

    @Update("UPDATE " + TABLE_NAME3 + " \n" + "SET gold = #{entity.gold},\n" + "player_id = #{entity.playerId},\n"
        + "diamond = #{entity.diamond},\n" + "lower_ball = #{entity.lowerBall},\n"
        + "middle_ball = #{entity.middleBall},\n" + "high_ball = #{entity.highBall},\n"
        + "skill_crit = #{entity.skillCrit},\n" + "skill_fast = #{entity.skillFast},\n"
        + "skill_lock = #{entity.skillLock},\n" + "skill_frozen = #{entity.skillFrozen},\n"
        + "boss_bugle = #{entity.bossBugle}\n" + "WHERE\n" + "id = #{entity.id}")
    int update3(@Param("entity") AppRewardLogEntity entity);

    @Update("UPDATE " + TABLE_NAME4 + " \n" + "SET gold = #{entity.gold},\n" + "player_id = #{entity.playerId},\n"
        + "diamond = #{entity.diamond},\n" + "lower_ball = #{entity.lowerBall},\n"
        + "middle_ball = #{entity.middleBall},\n" + "high_ball = #{entity.highBall},\n"
        + "skill_crit = #{entity.skillCrit},\n" + "skill_fast = #{entity.skillFast},\n"
        + "skill_lock = #{entity.skillLock},\n" + "skill_frozen = #{entity.skillFrozen},\n"
        + "boss_bugle = #{entity.bossBugle}\n" + "WHERE\n" + "id = #{entity.id}")
    int update4(@Param("entity") AppRewardLogEntity entity);
