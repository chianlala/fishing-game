...
namespace Game.UI
{
    public class UIDuiHuanJq : MonoBehaviour 
    {
        ...
        void InitFind()
        {
            ...
            btn_OpenGiftRecording = TransformFind("bg/btn_OpenGiftRecording").GetComponent<Button>();
            ...
            btn_adrees = TransformFind("bg/btn_adrees").GetComponent<Button>();
        ...
        void InitClickEvet()
        {
            btn_close.onClick.AddListener(() => {
                ...
                UIMgr.CloseUI(UIPath.UIDuiHuanJq); 
            });
        ...
        private void OnEnable()
        {
            ...
            EventManager.OpenAddress += On_OpenAddress; 
        }
        ...
        private void On_GetLotteryShopListResponse(UEventContext obj)
        {
            ...
            for (int i = 0; i < pack.shopItems.Count; i++)
            {
                ...
                Transform varDown = go.transform.Find("Image");
                Text txtNum = varDown.transform.Find("txt_num").GetComponent<Text>();
                ...
                Debug.Log("dataimg"+data.img.ToString());
