...
Shader "Custom/LeLeFishCubeGgAlpha"
{
        Properties{
            //高光贴图  边缘光  反射球  高度贴图 金属化  
           _Color("Color", Color) = (1,1,1,1)  //颜色  这个可以用来显示被击打颜色
           
           _Alpha("Alpha", Range(0,1)) = 1 // 边缘光的强度 也是范围
        ...
        SubShader{
          ...
          void surf(Input IN, inout SurfaceOutputStandard o) {
             ...
             // o.Emission = _RimColor.rgb * pow(rim, _RimPower);
              ...
              //自发光
              o.Emission = (tex2D(_EmissionTex, IN.uv_MainTex).rgb* _EmissionColor+ _RimColor.rgb * pow(rim, _RimPower))* _Alpha;
              
              
              o.Normal = UnpackNormal(tex2D(_BumpMap, IN.uv_BumpMap))* _Alpha;
              o.Metallic = tex2D(_JInTex, IN.uv_MainTex).rgb * _Metallic* _Alpha;
              o.Smoothness = _Glossiness* _Alpha;
           }
           ENDCG
       }
           Fallback "Diffuse"
