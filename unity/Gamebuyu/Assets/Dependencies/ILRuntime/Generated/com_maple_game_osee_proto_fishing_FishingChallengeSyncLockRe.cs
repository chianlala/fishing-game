...
{
    unsafe class com_maple_game_osee_proto_fishing_FishingChallengeSyncLockResponse_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(com.maple.game.osee.proto.fishing.FishingChallengeSyncLockResponse);
            args = new Type[]{};
        ...
        static StackObject* get_userId_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            com.maple.game.osee.proto.fishing.FishingChallengeSyncLockResponse instance_of_this_method = (com.maple.game.osee.proto.fishing.FishingChallengeSyncLockResponse)typeof(com.maple.game.osee.proto.fishing.FishingChallengeSyncLockResponse).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
