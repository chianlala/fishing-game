...
namespace JEngine.Helper
{
    public class RegisterDelegateConvertorHelper
    {
        ...
        public void Register(AppDomain appdomain)
        {
            ...
            appdomain.DelegateManager.RegisterDelegateConvertor<global::UIEventListener.BoolDelegate>((act) =>
            {
                return new global::UIEventListener.BoolDelegate((go, data, state) =>
                {
                    ((Action<UnityEngine.GameObject, UnityEngine.EventSystems.PointerEventData, System.Boolean>)act)(go, data, state);
                });
            });
            appdomain.DelegateManager.RegisterDelegateConvertor<global::UIEventListener.BoolDelegate>((act) =>
            {
            ...
            {
                return new global::UIEventListener.VoidDelegate((go, data) =>
                {
                    ((Action<UnityEngine.GameObject, UnityEngine.EventSystems.PointerEventData>)act)(go, data);
                });
            });
