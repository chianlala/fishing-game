...
namespace JEngine.Helper
{
    public class RegisterMethodDelegateHelper : IRegisterHelper
    {
        ...
        public void Register(AppDomain appdomain)
        {
            ...
            appdomain.DelegateManager.RegisterMethodDelegate<Int32, Int32>();
            appdomain.DelegateManager.RegisterMethodDelegate<NetLib.NetMsgPack>();
            appdomain.DelegateManager.RegisterMethodDelegate<UnityEngine.Sprite>();            appdomain.DelegateManager.RegisterMethodDelegate<UnityEngine.GameObject, UnityEngine.EventSystems.PointerEventData, System.Boolean>();
